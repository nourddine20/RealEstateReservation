(function ($) {
  ...
  $("#myonoffswitch5").change(function() {
    ...
    // GRADIENT LEFTMENU START
      ...
      $("#myonoffswitch19").change(function() {
                if(this.checked) {  
  ...
  $("#myonoffswitch7").change(function() {
       if(this.checked) {  
 ...
 $("#myonoffswitch8").change(function() {
                if(this.checked) {  
   ...
   $("#myonoffswitch20").change(function() {
    if(this.checked) {  
   ...
   $("#myonoffswitch9").change(function() {
         if(this.checked) {  
  ...
  $("#myonoffswitch10").change(function() {
     if(this.checked) {  
  ...
  $("#myonoffswitch11").change(function() {
                if(this.checked) {  
            ...
            $("#myonoffswitch12").change(function() {
                if(this.checked) {  
    ...
    $("#myonoffswitch13").change(function() {
            if(this.checked) {       
        if (this.checked) {
  ...
  $("#myonoffswitch14").change(function() {
            if(this.checked) {
    ...
    $("#myonoffswitch16").change(function() {
        if(this.checked) {
    ...
    // HOVER SUBMENU START
        $("#myonoffswitch17").change(function() {
         if(this.checked) {
  ...
  $("#myonoffswitch18").change(function() {
                if(this.checked) {
    ...
    if (bodyRtl) {
        ...
        (document.getElementById("style").setAttribute("href", "{{asset('clientside/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
...
// RTL STYLE START
        ...
        $("#myonoffswitch24").change(function() {
            if(this.checked) {
        $('body').addClass('rtl');
...
// LTR STYLE START
 $("#myonoffswitch23").change(function() {
      if(this.checked) {
        $('body').addClass('ltr');
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "{{asset('clientside/assets/plugins/bootstrap/css/bootstrap.min.css"));
        var carousel = $('.owl-carousel');
        $.each(carousel, function (index, element) {
            // element == this
            var carouselData = $(element).data('owl.carousel');
...
// LTR STYLE END
 ...
 $("#myonoffswitch34").change(function() {
            if(this.checked) {
        ActiveSubmenu();
...
// HORIZONTAL
 ...
 $("#myonoffswitch35").change(function() {
            if(this.checked) {
        if( !document.querySelector('.login-img') ){
            ActiveSubmenu();
            checkHoriMenu();
...
// HORIZONTAL HOVER
   ...
   $("#myonoffswitch111").change(function() {
            if(this.checked) {
        if( !document.querySelector('.login-img') ){
            checkHoriMenu();
            responsive();
