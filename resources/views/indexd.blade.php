    ...
    <div class="container">
      ...
      <div class="attr-nav">
        <ul class="social-media-dark social-top">
          <div class="col-md-3 col-sm-6"> <a href="tel:123-456-7890" class="btn btn-color btn-sm btn-circle">Appelez Nous</a> </div>
        </ul>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <input type="text" name="phone" class="form-control" id="phone" required="required" placeholder="Téléphone" data-error="Your Name is Required">
                <div class="help-block with-errors mt-20"></div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <input type="text" name="city" class="form-control" id="city" required="required" placeholder="Ville" data-error="Your Name is Required">
                <div class="help-block with-errors mt-20"></div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="widget widget-text">
            <div class="logo logo-footer"><a href="index.html"> <img class="logo logo-display" src="{{asset('frontside/assets/images/logo-white.png')}}" alt=""></a> </div>
