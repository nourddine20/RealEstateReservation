...
<head>
  ...
  <!-- FAVICON -->
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/clientside/assets/images/brand/favicon.ico')}}" />

    <!-- TITLE -->
    <title>Sash – Bootstrap 5 Admin & Dashboard Template</title>

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="{{asset('public/clientside/assets/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" />

    <!-- STYLE CSS -->
    <link href="{{asset('public/clientside/assets/css/style.css')}}" rel="stylesheet" />
    <link href="{{asset('public/clientside/assets/css/dark-style.css')}}" rel="stylesheet" />

    <!--- FONT-ICONS CSS -->
    <link href="{{asset('public/clientside/assets/css/icons.css')}}" rel="stylesheet" />

    <!-- COLOR SKIN CSS -->
    <link id="theme" rel="stylesheet" type="text/css" media="all" href="{{asset('public/clientside/assets/colors/color1.css')}}" />

    <!-- INTERNAL Switcher css -->
    <link href="{{asset('public/clientside/assets/switcher/css/switcher.css')}}" rel="stylesheet" />
    <link href="{{asset('public/clientside/assets/switcher/demo.css')}}" rel="stylesheet" />
...
<body class="app ltr landing-page horizontal">
    ...
    <div id="global-loader">
        <img src="{{asset('public/clientside/assets/images/loader.svg')}}" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
                ...
                <div class="container main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="{{asset('public/clientside/assets/images/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{asset('public/clientside/assets/images/brand/logo-3.png')}}" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                            ...
                            <div class="row">
                                <div class="main-sidemenu navbar px-0">
                                    <a class="navbar-brand ps-0 d-none d-lg-block" href="index.html">
                                        <img alt="" class="logo-2" src="{{asset('public/clientside/assets/images/brand/logo-3.png')}}">
                                        <img src="{{asset('public/clientside/assets/images/brand/logo.png')}}" class="logo-3" alt="logo">
                                    </a>
                                    <ul class="side-menu">
                                        <li class="slide">
                    ...
                    <div class="container px-sm-0">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 my-auto">
                                <img src="{{asset('public/clientside/assets/images/landing/market4.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row mt-7">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="card  features main-features main-features-2 wow fadeInUp reveal revealleft"
                                                    data-wow-delay="0.1s">
                                                    <div class="bg-img mb-2 text-left">
                                                        <!-- <img src="{{asset('public/clientside/assets/landing/images/features/demo.png')}}" alt=""> -->
                                                        <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 128 128">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 ps-0">
                                                                <div class="text-center reveal revealleft mb-3">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/business-team-working-on-business-plan.png')}}"
                                                                        alt="" class="br-5">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-12 px-0">
                                                            <div class="feature-logos mt-5">
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/1.png')}}">
                                                                    <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/2.png')}}">
                                                                    <h5 class="mt-3 text-white">HTML5</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/3.png')}}">
                                                                    <h5 class="mt-3 text-white">JQuery</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/4.png')}}">
                                                                    <h5 class="mt-3 text-white">Sass</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/5.png')}}">
                                                                    <h5 class="mt-3 text-white">Gulp</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{asset('public/clientside/assets/images/landing/web/6.png')}}">
                                        ...
                                        <section class="sptb demo-screen-demo" id="faqs">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-12 col-lg-6 reveal revealright">
                                                    <img src="{{asset('public/clientside/assets/images/landing/frequently-asked-questions.png')}}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </section>
                                                ...
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                            ...
                                                            data-bs-image-src="{{asset('public/clientside/assets/images/media/12.jpg')}}"
                                                            style="background: url(&quot;clientside/assets/images/media/12.jpg&quot;) center center;"></a>
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                            class="card-aside-column br-5 cover-image"
                                                            data-bs-image-src="{{asset('public/clientside/assets/images/media/22.jpg')}}"
                                                            style="background: url(&quot;clientside/assets/images/media/22.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                                            <span
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                            class="card-aside-column br-5 cover-image"
                                                            data-bs-image-src="{{asset('public/clientside/assets/images/media/about.jpg')}}"
                                                            style="background: url(&quot;clientside/assets/images/media/about.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                                            <span
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                            class="card-aside-column br-5 cover-image"
                                                            data-bs-image-src="{{asset('public/clientside/assets/images/media/25.jpg')}}"
                                                            style="background: url(&quot;clientside/assets/images/media/25.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                            ...
                                            <div class="card-body p-5 pb-6 text-dark">
                                                <div class="statistics-info p-4">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-xl-9">
                                                            <div class="">
                                                                <form id="ajaxpostdemande" class="m-t-20"
                                                                   method="POST" action="{{route('getajaxpost.demande')}}">
                                                                   @csrf
                                                                    <div class="form-group">
                                                                        <div class="col-xs-12">
                                                                           ...
                                                                           <div class="errorname  alert-danger">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-xs-12">
                                                                           ...
                                                                           <div class="errorphone  alert-danger">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-xs-12">
                                                                           ...
                                                                           <div class="erroremail  alert-danger">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-xs-12">
                                                                           ...
                                                                           <div class="errorsubject  alert-danger">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="errormessage  alert-danger">
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                        <div class="">
                                            <a href="index.html"><img loading="lazy" alt="" class="logo-2 mb-3"
                                                    src="{{asset('public/clientside/assets/images/brand/logo-3.png')}}"></a>
                                            <a href="index.html"><img src="{{asset('public/clientside/assets/images/brand/logo.png')}}"
    ...
    <!-- JQUERY JS -->
    <script src="{{asset('public/clientside/assets/js/jquery.min.js')}}"></script>

    <!-- BOOTSTRAP JS -->
    <script src="{{asset('public/clientside/assets/plugins/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>

         <!-- INTERNAL leaflet js -->
         <script src="{{asset('public/clientside/assets/plugins/leaflet/leaflet.js')}}"></script>
    <script src="{{asset('public/clientside/assets/js/map-leafleft.js')}}"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.2/leaflet.js" integrity="sha512-KMraOVM0qMVE0U1OULTDNEpUTHQoQUJMHLrErGJyHg89uy71MyuHHZ/0lBXyviDNVL+pBGwmeXQnuvGK8Fscvg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.2/leaflet-src.js" integrity="sha512-xrsuWl5/1jq4GGwAGzsBq5yJWXSsShD9OcCtY/rxCS8+2ag4uaFdW4trMLg9dj01bMhCmAmGxHSxkLhChWpQ7g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    
    <!-- COUNTERS JS-->
    <script src="{{asset('public/clientside/assets/plugins/counters/counterup.min.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/counters/waypoints.min.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/counters/counters-1.js')}}"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="{{asset('public/clientside/assets/plugins/owl-carousel/owl.carousel.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/company-slider/slider.js')}}"></script>


    <!-- Star Rating Js-->
    <script src="{{asset('public/clientside/assets/plugins/rating/jquery-rate-picker.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/rating/rating-picker.js')}}"></script>

    <!-- Star Rating-1 Js-->
    <script src="{{asset('public/clientside/assets/plugins/ratings-2/jquery.star-rating.js')}}"></script>
    <script src="{{asset('public/clientside/assets/plugins/ratings-2/star-rating.js')}}"></script>

    <!-- Sticky js -->
    <script src="{{asset('public/clientside/assets/js/sticky.js')}}"></script>

    <!-- CUSTOM JS -->
    <script src="{{asset('public/clientside/assets/js/landing.js')}}"></script>

     <!-- CUSTOM JS -->
     <script src="{{asset('public/clientside/assets/js/custom.js')}}"></script>

 

<!-- SIDE-MENU JS -->
<script src="{{asset('public/clientside/assets/plugins/sidemenu/sidemenu.js')}}"></script>

<!-- TypeHead js -->
<script src="{{asset('public/clientside/assets/plugins/bootstrap5-typehead/autocomplete.js')}}"></script>
<script src="{{asset('public/clientside/assets/js/typehead.js')}}"></script>

<!-- SIDEBAR JS -->
<script src="{{asset('public/clientside/assets/plugins/sidebar/sidebar.js')}}"></script>



<!-- Perfect SCROLLBAR JS-->
<script src="{{asset('public/clientside/assets/plugins/p-scroll/perfect-scrollbar.js')}}"></script>
<script src="{{asset('public/clientside/assets/plugins/p-scroll/pscroll.js')}}"></script>
<script src="{{asset('public/clientside/assets/plugins/p-scroll/pscroll-1.js')}}"></script>

<!-- Color Theme js -->
<script src="{{asset('public/clientside/assets/js/themeColors.js')}}"></script>
         ...
         //     console.log(response);
             ...
             if(response.status == 'success')
             {
                ...
                $content =  ` <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                    ...
                                                    <span class="alert-inner--text"><strong>Success </strong>`+response.msg+`</span>
                ...
                $('.errorphone').hide();
                    ...
                    $content =  `   <div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
                                                    <span class="alert-inner--icon"><i class="fe fe-slash"></i></span>
                                                    <span class="alert-inner--text"><strong>Error !</strong>`+response.msg+`!</span>
                                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                                            <span aria-hidden="true">×</span>
                                                        </button>
                                                </div>`;
