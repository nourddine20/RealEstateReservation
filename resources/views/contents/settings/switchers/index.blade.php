                                    ...
                                    <div class="card sidebar-right1">
                                        ...
                                        <div class="card-body">
											...
											<div class="skin-body switch_section">
												...
												<div class="switch-toggle d-flex mt-2">
													<a class="bg-img1 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="{{asset('clientside/assets/images/media/bg-img1.jpg')}}"  alt="Bg-Image" id="bgimage1" class="br-7"></a>
													<a class="bg-img2 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="{{asset('clientside/assets/images/media/bg-img2.jpg')}}"  alt="Bg-Image"  id="bgimage2" class="br-7"></a>
													<a class="bg-img3 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="{{asset('clientside/assets/images/media/bg-img3.jpg')}}"  alt="Bg-Image" id="bgimage3" class="br-7"></a>
													<a class="bg-img4 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="{{asset('clientside/assets/images/media/bg-img4.jpg')}}"  alt="Bg-Image" id="bgimage4" class="br-7"></a>
												</div>
											</div>
                                        </div>
                                        <div class="card-body">
                                        ...
                                        <div class="card-body leftmenu-styles">
											...
											<div class="switch_section">
												<div class="switch-toggle d-flex">
													...
													<p class="onoffswitch2"><input type="radio" checked name="onoffswitch6" id="myonoffswitch13" class="onoffswitch2-checkbox default-menu">
