                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header" style="display:flex;justify-content:space-between;">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btnaddcommercial" data-bs-toggle="modal" data-bs-target="#UpdateSupplierModal">
  Cree Nouveau commercial
</button>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table table-bordered text-nowrap border-bottom" >
                                                <thead>
                                                    <tr>
                                                      <th></th>
                                                         <th class="border-bottom-0" style="width:50px;">Id commercial</th>
                                                ...
                                                @foreach($allcommercials as $item)
                                                <tr>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li><a href="{{route('profile.commercial',[$item->id])}}" style="color:#60A5FA;"><i class="bi bi-eye-fill mx-2"></i><span class="mx-2">View</span></a></li>
                                                        ...
                                                        <li>  <a href="{{route('delete.commercial',['id'=>$item->id])}}"  style="color:red" onclick="return confirm('Are you sure you want to Delete this ?');"> <i class="bi bi-eye-fill mx-2" ></i><span class="mx-2">Delete</span></a></li>
        ...
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5" id="modaldemobody">
                    ...
                    <p class="mg-b-20 mg-x-20" id="message_response">Le commercial est Bien Ajouter En System .</p><button aria-label="Close" class="btn btn-success pd-x-25" onclick="{  location.reload();}" data-bs-dismiss="modal">Continue</button> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalforcheckdelete">
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
            <form id="multideleteform" action="{{route('multidelete.commercials')}}" method="POST">
                @csrf
...
$('.btnmodifier').on('click',function(){
  ...
  btnmodallabel = '#UpdateSupplierModal';
   ...
   console.log( $('#dropify-img'))
    arraysuppliers= [];
    idcommercial =$(this).attr('data-id');
   allcommercials = <?php echo $allcommercials ?>;
   console.log(allcommercials)
  allcommercials.forEach(element => {
  

    if(idcommercial == element.id){
      console.log(element)
    ...
    url="{{ route('update.commercial',':id') }}";
   
url = url.replace(':id',idcommercial);

  });
  
})

$('#btnaddcommercial').on('click',function(){
  idcommercial ='';
  // btnmodallabel = '#CreateSupplierModal';
  ...
  $('#name').val('');
    ...
    url="{{ route('createnew.commercial') }}";
