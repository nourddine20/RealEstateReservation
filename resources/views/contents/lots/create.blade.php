...
@section('content')
    ...
    <div class="card-body bg-white">
      ...
      <form id="formlotajax" action="{{route('store.lot')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="card-body row">
                        ...
                        <div class="modal-header my-2">Num Lot</div>
                                                <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid username is required: ex@abc.xyz">
                                                     ...
                                                     <input id="num_lot" type="number" class="form-control input-lg  @error('num_lot') is-invalid @enderror"    placeholder="Enter Num Lot" name="num_lot"  required autocomplete="num_lot" autofocus>
