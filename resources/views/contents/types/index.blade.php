                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                ...
                                                <thead>
                                                    <tr>
                                                      <th></th>
                                                         <th class="border-bottom-0">Id Type</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>  <a href="{{route('delete.type',['id'=>$item->id])}}"  style="color:red" onclick="return confirm('Are you sure you want to Delete this ?');"> <i class="bi bi-eye-fill mx-2" ></i><span class="mx-2">Delete</span></a></li>
        ...
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <p class="mg-b-20 mg-x-20">Le Type est Bien Ajouter En System .</p><button aria-label="Close" class="btn btn-success pd-x-25" onclick="{  location.reload();}" data-bs-dismiss="modal">Continue</button>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="UpdateSupplierModalLabel">Create a Type</h1>
...
<span class="errorpassword">
   ...
   <div class="modal fade" id="modalforcheckdelete">
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
            <form id="formdeletesuppliers" action="{{route('multidelete.types')}}" method="POST">
                @csrf
...
$('.btnmodifier').on('click',function(){
  ...
  $('#UpdateSupplierModalLabel').val('Update Type');
    arrayTypes= [];
    idType =$(this).attr('data-id');
   alltypes = <?php echo $alltypes?>;
   console.log(alltypes)
  alltypes.forEach(element => {
  

    if(idType == element.id){
      console.log(element)
    console.log($('#dropify-img').attr('src'))
      $('#label').val(element.label);
      $('#dropify-img').attr('src',element.img_cat);
     
    }
   

    url="{{ route('update.type',':id') }}";

    url = url.replace(':id',idType);
...
$('#btnaddsupplier').on('click',function(){
  ...
  $('#UpdateSupplierModalLabel').val('Create Type');
  $('#label').val('');
    $('.dropify').val('');
