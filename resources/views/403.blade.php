...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('clientside/assets/images/brand/favicon.ico')}}" />
                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5 mb-5" href="{{route('admin.home')}}"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
                        </div>
                    </div>
                </div>
            </div>
